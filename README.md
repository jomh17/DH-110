...
|**10. Help and documentation:** Provide easy to locate documentation to help with commonly asked questions and allow the user to quickly find answers.|**Bad:** There is no section for frequently asked questions|**Improvements:** A Q&A section needs to be added so that users can easily get help. (Level 3 priority)|
